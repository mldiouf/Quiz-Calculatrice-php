                    ...
                    <p><?php
                      if(isset($_POST['btn4'])){
                        ...
                        if($_SESSION['result'] == $_POST['reponse']){
                            ...
                            array_push( $_SESSION['Tab_reponse'],array($val=> "true")  );
                            ...
                            $_SESSION['n']+=1;
                            $val= strval($_SESSION['i'].'X'.$_SESSION['j'].'='.$_SESSION['result']);
                            array_push( $_SESSION['Tab_reponse'],array($val=> "false")  );
                      ...
                      ?>
                                     <button class="btn btn-success btn-large mt-3 " type="submit" name="btn4"><a href="imprimer2.php">Generer PDF</a></button>
